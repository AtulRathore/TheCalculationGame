    ...
    public void playAgain(View view){
        ...
        new CountDownTimer(3100, 1000){
            ...
            public void onFinish() {
                ...
                resultTV.setText("Your Score" + Integer.toString(gameScore) + "/" +
...
//        Log.i("Tag", (String) view.getTag());
        ...
        numberOfProblems++;
        pointsTV.setText(Integer.toString(gameScore) + "/" + Integer.toString(numberOfProblems));
        generateQuestion();
    }
